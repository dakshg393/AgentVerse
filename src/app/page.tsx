...
export default function LandingPage() {
        ...
        <div className='flex items-center justify-start flex-row gap-x-6 overflow-x-auto no-scrollbar w-[80%]'>
          ...
          {agentsOverview.map((overview,index)=> (
            ...
            <CardContent className='h-[80%] p-0 '>
              <video className='h-full object-cover rounded-2xl' src={overview.url} autoPlay muted loop playsInline />
            </CardContent>
  ...
  </div>  <div className="  p-4 rounded-xl border-2  transition-transform duration-300 hover:-translate-y-1 shadow-sm hover:shadow-md  dark:shadow-white">
...
{/* User Testimonials  */}
  ...
  <div className="col-span-1 lg:col-span-2 row-span-2 border-2  p-6 rounded-2xl flex flex-col justify-between transition-transform duration-300 hover:-translate-y-1 shadow-sm hover:shadow-md  dark:shadow-white  ">
    <p className="italic ">"Absolutely phenomenal product — our entire team productivity has improved 10x."</p>
  ...
  <div className="col-span-1 lg:col-span-2 border-2   p-6 rounded-2xl  transition-transform duration-300 hover:-translate-y-1 shadow-sm hover:shadow-md  dark:shadow-white">
    <p className="italic ">"The UI is sleek, and the automation tools saved us tons of manual work."</p>
    <div className="mt-4 flex items-center gap-3">
  ...
  {testimonials.map((testimonial, i) => (
    <div key={i} className=" shadow p-5 border-2 rounded-2xl flex flex-col justify-between transition-transform duration-300 hover:-translate-y-2 hover:shadow-md dark:shadow-white">
      ...
      {/* Pricing */}
      <section className='flex pt-30 items-center justify-center flex-wrap h-auto  w-screen  flex-col p-4'>
        ...
        {Plans.map((plan) => {
          return (
            <Card className='hover:-translate-y-2 h-full '>
...
{/* Frequently asked questions */}
      <section className='flex pt-30 items-center justify-center flex-wrap flex-col w-screen p-4 '>
        <h1 className='text-2xl md:text-4xl font-bold text-center pb-10'> Frequently asked questions  </h1>


        <div className="space-y-6  w-full flex items-center justify-center flex-col">
      {faqs.map((faq, index) => (
        <Card key={index} onClick={() => toggleFAQ(index)} className="cursor-pointer w-[80%] md:w-[50%] ">
