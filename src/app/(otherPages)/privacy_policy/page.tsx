    ...
    <section className="w-full min-h-screen px-4 py-10 flex flex-col items-center bg-muted">
      ...
      <Card className="w-full max-w-3xl shadow-lg">
        ...
        <CardContent className="space-y-4 text-sm leading-6 text-muted-foreground">
          <p>
            <strong>Effective Date:</strong> 22/5/2025
          </p>

          <p>
            At <strong>AgentVerse</strong>, your privacy is our priority. This Privacy Policy
          ...
          <ul className="list-disc list-inside">
            <li>
              <strong>Personal Information:</strong> Such as name, email address, and contact
              details that you voluntarily provide.
            </li>
            <li>
              <strong>Usage Data:</strong> Information like pages visited, time spent, and clicks,
              used for analytics.
            </li>
            <li>
              <strong>Cookies & Tracking:</strong> Technologies that help us improve user experience
              and performance.
            </li>
          </ul>
          ...
          <p>
            This policy may be updated periodically. All changes will be posted on this page with an
