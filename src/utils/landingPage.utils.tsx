const faqs =[
        ...
        },
        {
          ...
          "answer": "Users configure intelligent agents by choosing their role and personality. They can then interact live with these agents through voice or text using advanced AI models and voice synthesis technologies."
        },
        {
          "question": "What types of agents can I use?",
          "answer": "AgentVerse offers a variety of pre-built agents including AI Interview Coach, Healthcare Advisor, Legal Consultant, Business Strategist, and even custom assistants tailored to your needs."
        },
        {
          "question": "Can I create my own custom AI agent?",
          "answer": "Yes, AgentVerse allows full customization. You can define the agent’s name, voice, knowledge domain, personality traits, and more, without writing any code."
        },
        {
          "question": "Who is AgentVerse for?",
          "answer": "AgentVerse is ideal for job seekers, marketers, agencies, HR teams, legal and healthcare professionals, and anyone looking to automate human-like interactions using AI."
        },
        {
          "question": "Is interaction really in real-time?",
          "answer": "Absolutely. AgentVerse uses real-time voice-to-text and text-to-voice processing, making your interactions with AI agents feel instant and human-like."
        },
        {
          "question": "Do I need technical skills to use AgentVerse?",
          "answer": "No technical skills are needed. The platform is designed with an intuitive interface so anyone can build and deploy agents in just a few clicks."
        },
        {
          "question": "Is my data safe with AgentVerse?",
          "answer": "Yes, we take security seriously. All interactions are encrypted and stored securely, with compliance to GDPR and other data privacy regulations."
        },
        {
          "question": "Can I integrate agents into my website or app?",
          "answer": "Yes, you can embed agents into any site or platform via API or iframe widget, enabling powerful automation and interactivity for your users."
        },
        {
          "question": "Is there a free trial?",
          "answer": "Yes, AgentVerse offers a 7-day free trial so you can explore all features without any upfront cost or credit card required."
        }
]
